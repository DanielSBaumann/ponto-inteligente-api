package com.org.dsb.pontoeletronico.security.utils;
...
public class JwtTokenUtil {
    ...
    //@Value("#{T(java.lang.Float).parseFloat('${jwt.expiration:{number}}')}")
    ...
    public String obterToken(UserDetails userDetails) {
        ...
        userDetails
                .getAuthorities()
                .forEach(auth -> claims.put(CLAIM_KEY_ROLE, auth.getAuthority()));
        claims
    ...
    /**
     * Realiza o parse do token JWT para extrair as informaçoes contidas
     * no corpo dele.
     *
     * @param token
     * @return Claims
    ...
    /**
     * Retorna data de expiracao com base na data atual
     *
     * @return Date
     */
